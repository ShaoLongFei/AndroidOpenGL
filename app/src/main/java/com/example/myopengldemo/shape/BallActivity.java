...
public class BallActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setRender(new BallRender());
    }

    private class BallRender implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            mProgram = OpenGLUtils.createProgramAndLink(getResources(), "vshader/Ball.sh", "fshader/Cone.sh");
        }
